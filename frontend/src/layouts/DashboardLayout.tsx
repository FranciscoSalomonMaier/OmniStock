...
export function DashboardLayout() {
  ...
  const [expanded, setExpanded] = useState<Record<string, boolean>>({ Empresas: true, Produtos: true, 'Minha conta': true })
