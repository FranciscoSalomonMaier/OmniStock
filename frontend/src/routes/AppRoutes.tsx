      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<DashboardLayout />}>
          ...
          <Route element={<CompanyRequiredRoute />}>
            ...
            <Route path="/settings/company/members" element={<MembersPage />} />
            ...
            />
            <Route
              path="/inventory/exits/new"
              element={<InventoryOperationPage kind="exits" />}
            />
            <Route
              path="/inventory/adjustments/new"
              element={<InventoryOperationPage kind="adjustments" />}
            />
            <Route
            ...
            <Route
              ...
              element={<InventoryOperationPage kind="reservations" />}
            />
            <Route
            ...
            />
            <Route
              path="/integrations/mercado-livre/:connectionId/listings"
              element={<MercadoLivreListingsPage />}
            />
            <Route
              path="/integrations/mercado-livre/:connectionId/orders"
              element={<MercadoLivreOrdersPage />}
            />
          </Route>
        </Route>
      </Route>
